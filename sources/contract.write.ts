...
import { SampleTactContract,Multiply,Divide } from "./output/sample_SampleTactContract";
...
(async () => {
    ...
    await contract_open.send(walletSender, {value: toNano("0.01")}, {
        $$type: 'Multiply', val: 2n
    } as Multiply);
